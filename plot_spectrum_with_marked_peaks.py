...
def plot_spectrum_with_marked_peaks(x, spectrum_1, spectrum_2, spectrum_3, spectrum_4, save_path, peak_wavenumbers):
    ...
    plt.plot(x, mean_1, label='1000', color='red')
    plt.fill_between(x, mean_1 - std_1, mean_1 + std_1, color='red', alpha=0.2)
    plt.plot(x, mean_2, label='2000', color='orange')
    plt.fill_between(x, mean_2 - std_2, mean_2 + std_2, color='orange', alpha=0.2)
    plt.plot(x, mean_3, label='3000', color='green')
    plt.fill_between(x, mean_3 - std_3, mean_3 + std_3, color='green', alpha=0.2)
    plt.plot(x, mean_4, label='4000', color='blue')
